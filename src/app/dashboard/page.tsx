...
import { PlusCircle, DollarSign, Activity, ShoppingBag, FileText, CheckCircle } from "lucide-react"
import { siteConfig } from "@/config/site"

const transactions = [
  { id: "1", date: "2023-10-26", amount: 50, status: "Completed", description: "Coffee purchase" },
  { id: "2", date: "2023-10-25", amount: -200, status: "Completed", description: "IBAN Payout" },
  { id: "3", date: "2023-10-24", amount: 120, status: "Completed", description: "Hotel Booking" },
  { id: "4", date: "2023-10-23", amount: 75, status: "Pending", description: "Excursion service" },
];
          ...
          <CardContent>
            ...
            {applicationStatus === 'approved' && (
                <div className="flex flex-col items-center">
                    ...
                    <p className="text-muted-foreground">Congratulations! Your application is approved. Redirecting you to the merchant dashboard...</p>
                </div>
            )}
          </CardContent>
        </Card>
