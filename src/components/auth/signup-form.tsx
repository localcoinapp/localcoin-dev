  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    try {
      ...
      toast({
        title: "Almost there!",
        description:
          "Your account has been created. Please check your email to verify your account and then log in.",
        duration: 9000,
      })
        ...
        <div className="space-y-2">
          <Button variant="outline" className="w-full" onClick={handleGoogleSignIn}>
            ...
            >
              <path
                fill="currentColor"
                d="M488 261.8C488 403.3 391.1 504 248 504 110.8 504 0 393.2 0 256S110.8 8 248 8c66.8 0 126 23.4 172.9 62.3l-68.6 68.6c-20.5-19.4-48-31.5-79.3-31.5-62.3 0-113.5 51.6-113.5 114.9s51.2 114.9 113.5 114.9c72.3 0 96.9-46.3 102.5-69.1H248v-85.3h236.1c2.3 12.7 3.9 26.9 3.9 41.4z"
              ></path>
            </svg>
            Sign up with Google
          </Button>
          <Button variant="outline" className="w-full" onClick={handleAppleSignIn}>
            ...
            >
              <path
                fill="currentColor"
                d="M318.7 268.7c-.2-36.7 16.4-64.4 50-84.8-18.8-26.9-47.2-41.7-84.7-44.6-35.5-2.8-74.3 20.7-88.5 20.7-15 0-49.4-19.7-76.4-19.7C39.2 141.6 0 184.2 0 241.2c0 61.6 31.3 117.4 58.8 152.4 26.8 34.1 56.2 43.2 89.2 42.8 28.5-.3 55-11.4 77.2-11.4 21.3 0 44.4 11.9 70.2 11.9 33.6 0 62.5-11.4 86.7-34.9 21.6-20.8 34.9-50.7 34.9-85.8zM216.5 81.6c14.2-16.1 21.2-35.1 21.2-53.1-22.5.2-42.9 8.2-59.2 24.3-14.9 14.9-24.8 34.9-22.5 53.8 23.1-.4 42.9-8.7 59.2-24.3z"
              ></path>
            </svg>
            Sign up with Apple
          </Button>
